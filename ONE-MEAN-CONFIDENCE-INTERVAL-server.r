...
res <- ceiling((z * input$sd / input$d) ^ 2)
}
else {
if (input$one.sided) f <- function(x) (qt(input$conf, x - 1) * input$sd / input$d) ^ 2 - x else f <- function(x) ((qt((1 + input$conf) / 2, x - 1)) * input$sd / input$d) ^ 2 - x
