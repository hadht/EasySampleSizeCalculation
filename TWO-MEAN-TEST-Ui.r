...
headerPanel("Hypothesis Test for Two Means"),
sidebarPanel(
...
label = "standard deviation (population 1)",
value = 15,
min = 0,
),
numericInput(inputId = "sd2",
label = "standard deviation (population 2)",
value = 15,
min = 0,
),
...
checkboxInput("two.sided", "two sided test", TRUE),
checkboxInput("sd.known", "known standard deviations", TRUE)
),
mainPanel(
h3("The Sample Size"),
textOutput("Answer")
